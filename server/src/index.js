...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'us-you-be-the-president', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[us-you-be-the-president] listening on :${config.port} — sessions live in memory only`);
});
